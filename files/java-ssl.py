...
class Authority(object):
    def __init__(self, base_directory, **kwargs):
        ...
        self.key = OpensslKey("ca", self.base_directory, **(kwargs.get("key", dict())))
        self.certificate = OpensslCertificate("ca", self.base_directory, self.key, self.password, **(kwargs.get("cert", dict())))
